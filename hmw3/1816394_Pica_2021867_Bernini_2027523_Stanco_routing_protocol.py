...
class AIRouting_1816394_Pica_2021867_Bernini_2027523_Stanco(BASE_routing):
    ...
    def relay_selection(self, opt_neighbors, pkd):
        ...
        # -2 --> move to depot
        if action == 3:
            AIRouting_1816394_Pica_2021867_Bernini_2027523_Stanco.move_to_depot_2 += 1
            drone_to_send = -2
            # Cell of depot
        ...
        # -1 --> move to depot
        if action == 2:
            AIRouting_1816394_Pica_2021867_Bernini_2027523_Stanco.move_to_depot_1 += 1
            drone_to_send = -1
            # Cell of depot
            next_target_cell = int(util.TraversedCells.coord_to_cell(size_cell=self.simulator.prob_size_cell,
                                                                     width_area=self.simulator.env_width,
        ...
        if action == 1:
            AIRouting_1816394_Pica_2021867_Bernini_2027523_Stanco.keep_pkt += 1
            drone_to_send = None
            next_target_cell = int(util.TraversedCells.coord_to_cell(size_cell=self.simulator.prob_size_cell,
                                                                     width_area=self.simulator.env_width,
        ...
        # send packet
            ...
            AIRouting_1816394_Pica_2021867_Bernini_2027523_Stanco.send_pkt += 1
    ...
    def print(self):
        ...
        print("Send the Packet: ", AIRouting_1816394_Pica_2021867_Bernini_2027523_Stanco.send_pkt)
        print("Keep the Packet: ", AIRouting_1816394_Pica_2021867_Bernini_2027523_Stanco.keep_pkt)
        print("Move to Depot 1: ", AIRouting_1816394_Pica_2021867_Bernini_2027523_Stanco.move_to_depot_1)
        print("Move to Depot 2: ", AIRouting_1816394_Pica_2021867_Bernini_2027523_Stanco.move_to_depot_2)
        print("####################################\n")
