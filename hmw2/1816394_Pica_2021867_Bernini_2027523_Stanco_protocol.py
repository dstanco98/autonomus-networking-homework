...
class X_RP_1816394_Pica_2021867_Bernini_2027523_Stanco(BASE_routing):
    keep_pkt = 0
    send_pkt = 0
    move_to_depot = 0
    ...
    def __init__(self, drone, simulator):
        ...
        self.action_number = 3  # we consider 3 actions: 0:send_pkt, 1:keep_pkt, 2:move_to_depot
    ...
    def relay_selection(self, opt_neighbors, pkd):
        ...
        # -1 --> move to depot
        if action == 2:
            X_RP_1816394_Pica_2021867_Bernini_2027523_Stanco.move_to_depot += 1
            drone_to_send = -1
            # Cell of depot
        ...
        if action == 1:
            X_RP_1816394_Pica_2021867_Bernini_2027523_Stanco.keep_pkt += 1
            drone_to_send = None
            next_target_cell = int(util.TraversedCells.coord_to_cell(size_cell=self.simulator.prob_size_cell,
                                                                     width_area=self.simulator.env_width,
        ...
        # send packet
            ...
            X_RP_1816394_Pica_2021867_Bernini_2027523_Stanco.send_pkt += 1
    ...
    def print(self):
        ...
        print("Send the Packet: ", X_RP_1816394_Pica_2021867_Bernini_2027523_Stanco.send_pkt)
        print("Keep the Packet: ", X_RP_1816394_Pica_2021867_Bernini_2027523_Stanco.keep_pkt)
        print("Move to Depot: ", X_RP_1816394_Pica_2021867_Bernini_2027523_Stanco.move_to_depot)
        print("####################################\n")